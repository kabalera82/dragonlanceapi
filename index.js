...
app.get('/apidragonlance', (req, res) => {
    res.status(200).json({
        ...
        documentation: {
            characters: [
            { method: "GET", url: "https://k82studio.com/apidragonlance/characters", description: "Ver todos los personajes" },
                { method: "GET", url: "https://k82studio.com/apidragonlance/characters/:id", description: "Ver personaje por ID" },
                { method: "GET", url: "https://k82studio.com/apidragonlance/characters/name/:name", description: "Buscar por nombre" },
                { method: "POST", url: "https://k82studio.com/apidragonlance/characters", description: "Crear personaje nuevo" },
                { method: "PUT", url: "https://k82studio.com/apidragonlance/characters/:id", description: "Editar personaje" },
                { method: "DELETE", url: "https://k82studio.com/apidragonlance/characters/:id", description: "Eliminar personaje" }
            ],
            books: [
                { method: "GET", url: "https://k82studio.com/apidragonlance/books", description: "Ver todos los libros" },
                { method: "GET", url: "https://k82studio.com/apidragonlance/books/:id", description: "Ver libro por ID" },
                { method: "POST", url: "https://k82studio.com/apidragonlance/books", description: "Crear libro nuevo" },
                { method: "PUT", url: "https://k82studio.com/apidragonlance/books/:id", description: "Editar libro" },
                { method: "DELETE", url: "https://k82studio.com/apidragonlance/books/:id", description: "Eliminar libro" }
            ]
        }
    });
});
